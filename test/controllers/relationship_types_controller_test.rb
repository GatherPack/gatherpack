...
class RelationshipTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship_type" do
    assert_difference("RelationshipType.count") do
      post relationship_types_url, params: { relationship_type: { child_label: @relationship_type.child_label, name: @relationship_type.name, parent_label: @relationship_type.parent_label } }
    end
  ...
  test "should update relationship_type" do
    patch relationship_type_url(@relationship_type), params: { relationship_type: { child_label: @relationship_type.child_label, name: @relationship_type.name, parent_label: @relationship_type.parent_label } }
