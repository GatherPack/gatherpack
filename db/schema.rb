...
ActiveRecord::Schema[8.0].define(version: 2025_08_18_001701) do
  ...
  create_table "relationship_types", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "parent_permissions", default: [], array: true
    t.string "child_permissions", default: [], array: true
  end
